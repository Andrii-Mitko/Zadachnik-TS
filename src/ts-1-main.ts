...
//! enum - жёстко заданные варианты значений с именами в об'єкті

//! RegExp - это способ искать, проверять и изменять текст по шаблону.

// 🔹 Для каждого тега есть свой тип
...
// <a> → HTMLAnchorElement
// <ul> → HTMLUListElement ✔️
// <ol> → HTMLOListElement ✔️
// <li> → HTMLLIElement ✔️

// HTMLElement → общий (меньше возможностей)

// Promise<T> = “обещание вернуть значение типа T позже”
