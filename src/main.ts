...
// TypeScript сам понимает, что в переменной содержится объект и сам контролирует структуру этого объекта, предохраняя его от непредусмотренных изменений. В следующих уроках мы разберемся в работе с объектами подробнее.
